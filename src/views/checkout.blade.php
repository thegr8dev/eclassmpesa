	            		...
	            		<div id="accordion" class="second-accordion">
							...
							<div class="card">
	                            <div class="card-header" id="headingFour">
							        <div class="panel-title">
							            <label for='mpesalabel'>
							              ...
							              <img src="{{ url('images/payment/mpesa.png') }}"  class="img-fluid" alt="course"> 
							            </label>
							        </div>
						    	</div>
							    <div id="mpesa" class="panel-collapse collapse in">
							        <div class="card-body">
		                            	<div class="payment-proceed-btn">
		                            		<form method="POST" action="{{ route('stkpush') }}" class="form-horizontal" role="form">
		                            			@csrf
											        ...
											        <div class="col-md-12">
											            <div class="form-group">
											                <strong>Enter Phone No: <span class="text-danger">*</span></strong>
											                <input type="text" name="phone" class="form-control" placeholder="Enter Phone no with code 254" required>
											            </div>
											        </div>
